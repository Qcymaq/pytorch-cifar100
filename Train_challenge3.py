...
from ResNet_challenge3 import *
from dataset_new import ChineseCharacterDataset  
import pandas as pd
import os

def train_model(model, train_loader, val_loader, num_classes, batch_size=32, learning_rate=0.01, num_epochs=50, patience=5):
    ...
    checkpoint_dir = 'checkpoints/resnet18_cangjie'
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            checkpoint_path = os.path.join(checkpoint_dir, f'resnet18_epoch_{epoch + 1}_valacc_{val_accuracy:.2f}.pth')
...
if __name__ == '__main__':
    ...
    model = resnet18_modified(num_radicals=len(char_to_label))  
