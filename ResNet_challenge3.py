...
class ModifiedResNet(nn.Module):
    def __init__(self, block, num_block, num_radicals=26):
        super().__init__()
        self.in_channels = 64
        ...
        # Adjust output features based on the number of radicals
        self.fc = nn.Linear(512 * block.expansion, 5 * num_radicals)
...
def resnet18_modified(num_radicals=26):
    return ModifiedResNet(BottleneckBlock, [2, 2, 2, 2], num_radicals)
